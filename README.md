...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mediafile-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15324&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mediafile-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mediafile` can be installed with:

```
conda install mediafile
```

It is possible to list all of the versions of `mediafile` available on your platform with:
